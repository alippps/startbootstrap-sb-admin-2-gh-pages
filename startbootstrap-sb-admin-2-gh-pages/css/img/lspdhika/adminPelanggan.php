                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post">
                                            <div class="modal-body">
                                                ...
                                                <input type="text" class="form-control" placeholder="ID PELANGGAN" name="idpelanggan" readonly="readonly">
                                            </div>
                                            <div class="modal-body">
                                                <label class="form-label">Nama Pelanggan</label>
                                                <input type="text" class="form-control" placeholder="Nama Pelanggan" name="Namapelanggan" required>
                                            </div>
                                            <div class="modal-body">
                                                <label class="form-label">Jenis Kelamin</label>
                                                <input type="text" class="form-control" placeholder="Jenis Kelamin" name="Jeniskelamin" required>
                                            </div>
                                            <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="tambahAP">Tambah</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <thead class="table-primary">
                                    ...
                                    <tbody>
                                        ...
                                        while ($tampil = mysqli_fetch_array($ambildata)) {
                                            ...
                                            $Namapelanggan = $tampil['Namapelanggan'];
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $Alamat; ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-warning mb-2" data-toggle="modal" data-target="#edit<?= $idpelanggan; ?>">Edit</button>
                                                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete<?= $idpelanggan; ?>">Delete</button>
                                                </td>
                                                <!--AwaL Modal Edit Data -->
                                                <div class="modal fade" id="edit<?= $idpelanggan; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <form method="post" action="function.php">
                                                                <div class="modal-body">
                                                                    <label class="form-label">ID Pelanggan</label>
                                                                    <input type="text" class="form-control" value="<?= $idpelanggan; ?>" name="idpelanggan" readonly="readonly">
                                                                </div>
                                                                <div class="modal-body">
                                                                    <label class="form-label">Nama Pelanggan</label>
                                                                    <input type="text" class="form-control" value="<?= $Namapelanggan; ?>" name="Namapelanggan">
                                                                </div>
                                                                <div class="modal-body">
                                                                    <label class="form-label">Jenis Kelamin</label>
                                                                    <input type="text" class="form-control" value="<?= $Jeniskelamin; ?>" name="Jeniskelamin">
                                                                </div>
                                                                <div class="modal-body">
                                                                    <label class="form-label">No HP</label>
                                                                    <input type="text" class="form-control" value="<?= $Nohp; ?>" name="Nohp">
                                                                </div>
                                                                <div class="modal-body">
                                                                    <label class="form-label">Alamat</label>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary" name="editAP" value="<?= $idpelanggan; ?>">Edit</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <!-- AwalModal Delete -->
                                                <div class="modal fade" id="delete<?= $idpelanggan; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    Apaka anda yakin ingin menghapus <?= $Namapelanggan ?> ?
                                                                    <input type="hidden" name="idpelanggan" value="<?= $idpelanggan; ?>">
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-danger" name="hapusAP">Hapus</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
