...
$get1 = mysqli_query($conn, "select * from menu where idmenu");
$count1 = mysqli_num_rows($get1);

$get2 = mysqli_query($conn, "select * from meja where idMeja");
$count2 = mysqli_num_rows($get2);

$get3 = mysqli_query($conn, "select * from pesanan where idpesanan");
$count3 = mysqli_num_rows($get3);

$get4 = mysqli_query($conn, "select * from pelanggan where idpelanggan");
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>LSP &copy; Andhika 12 RPL 3</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
