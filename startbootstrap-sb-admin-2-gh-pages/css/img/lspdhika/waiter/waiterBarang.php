                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post">
                                            <div class="modal-body">
                                                ...
                                                <input type="text" class="form-control" placeholder="ID MENU" name="idmenu" readonly="readonly">
                                            </div>
                                            <div class="modal-body">
                                                <label class="form-label">Nama Menu</label>
                                                <input type="text" class="form-control" placeholder="Nama Menu" name="Namamenu" required>
                                            </div>
                                            <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="tambahWB">Tambah</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-warning mb-2" data-toggle="modal" data-target="#edit<?= $idmenu; ?>">Edit</button>
                                                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#delete<?= $idmenu; ?>">Delete</button>
                                                </td>
                                                <!--AwaL Modal Edit Data -->
                                                <div class="modal fade" id="edit<?= $idmenu; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <form method="post" action="../function.php">
                                                                <div class="modal-body">
                                                                    <label class="form-label">ID MENU</label>
                                                                    <input type="text" class="form-control" value="<?= $idmenu; ?>" name="idmenu" readonly="readonly">
                                                                </div>
                                                                <div class="modal-body">
                                                                    <label class="form-label">Nama Menu</label>
                                                                    <input type="text" class="form-control" value="<?= $Namamenu; ?>" name="Namamenu">
                                                                </div>
                                                                <div class="modal-body">
                                                                    <label class="form-label">Harga</label>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary" name="editWB" value="<?= $idmenu; ?>">Edit</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <!-- AwalModal Delete -->
                                                <div class="modal fade" id="delete<?= $idmenu; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    Apaka anda yakin ingin menghapus <?= $Namamenu ?> ?
                                                                    <input type="hidden" name="idmenu" value="<?= $idmenu; ?>">
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-danger" name="hapusWB">Hapus</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
